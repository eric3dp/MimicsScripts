...
aliases = {
    ...
    "Aorta": ["AO", "Ao"],
    "Right Atrium": ["RA", "Right_Atrium", "Right-Atrium"],
    "Left Atrium": ["LA", "Left_Atrium", "Left-Atrium"],
    "Left Ventricle": ["LV", "Left_Ventricle", "Left-Ventricle"],
    "Right Ventricle": ["RV", "Right_Ventricle", "Right-Ventricle"],
    "Coronary": ["Coronar"],
}
